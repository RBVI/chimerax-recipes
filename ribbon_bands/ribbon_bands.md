# Draw colored bands on molecule ribbons

Roden Luo asked how to draw several colored bands on a ribbon for each residue.  Here is some Python code [ribbon_bands.py](ribbon_bands.py) demonstrating how this can be done for helices.  This will not save in sessions.  The code defines a new command bands that takes a residue specification and a color

    open ribbon_bands.py
...
<img src="ribbon_bands.png" width="300">

Here is the [ribbon_bands.py](ribbon_bands.py) code:
